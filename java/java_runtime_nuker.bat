...
reg delete "HKLM\SOFTWARE\Wow6432Node\JavaSoft\Auto Update" /f>> "%LOGPATH%\%LOGFILE%" 2>NUL
reg delete "HKLM\SOFTWARE\Wow6432Node\JavaSoft\Java Plug-in" /f>> "%LOGPATH%\%LOGFILE%" 2>NUL
reg delete "HKLM\SOFTWARE\Wow6432Node\JavaSoft\Java Runtime Environment" /f>> "%LOGPATH%\%LOGFILE%" 2>NUL
reg delete "HKLM\SOFTWARE\Wow6432Node\JavaSoft\Java Update" /f>> "%LOGPATH%\%LOGFILE%" 2>NUL
reg delete "HKLM\SOFTWARE\Wow6432Node\JavaSoft\Java Web Start" /f>> "%LOGPATH%\%LOGFILE%" 2>NUL
...
reg delete "HKLM\SOFTWARE\JavaSoft\Auto Update" /f>> "%LOGPATH%\%LOGFILE%" 2>NUL
reg delete "HKLM\SOFTWARE\JavaSoft\Java Plug-in" /f>> "%LOGPATH%\%LOGFILE%" 2>NUL
reg delete "HKLM\SOFTWARE\JavaSoft\Java Runtime Environment" /f>> "%LOGPATH%\%LOGFILE%" 2>NUL
reg delete "HKLM\SOFTWARE\JavaSoft\Java Update" /f>> "%LOGPATH%\%LOGFILE%" 2>NUL
reg delete "HKLM\SOFTWARE\JavaSoft\Java Web Start" /f>> "%LOGPATH%\%LOGFILE%" 2>NUL
